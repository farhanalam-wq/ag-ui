...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-zinc-900 bg-zinc-950 text-zinc-100" {...props}>
      <SidebarHeader className="border-b border-zinc-900/80 p-2">
        <CompanySwitcher
          companies={companies}
      ...
      <SidebarContent className="space-y-2 py-2">
        ...
        />
        <SidebarSeparator className="bg-zinc-900 mx-2" />
        <NavKnowledge
      ...
      <SidebarFooter className="border-t border-zinc-900/80 p-2">
        <NavUser />
      </SidebarFooter>
